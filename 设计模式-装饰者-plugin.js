...
const userBehavePlugin = function () {
  ...
  return {
    remove: function () {
      console.log(`${userName} get local info, delete it 12h later.`)
    },
    // 不覆盖，同时调用
    get: function (super_fn, key) {
      const val = super_fn(key, "newParam"); // 旧函数
      return "this is the user name:" + val;
    }
  }
}
